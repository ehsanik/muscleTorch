...
class WalkableModel(BaseModel):
    ...
    def loss(self, args):
        return self.loss_function(args, args.classification_weights)
    ...
    def forward(self, input, target):
        ...
        walk = self.depth_up5(d2_)


        assert walk.shape[1] == 2

        output = {
            'walk': walk.unsqueeze(1), #Put sequence length back
        }
